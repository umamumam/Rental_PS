...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('awal/favicon.png') }}">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                ...
                <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                    <li><a class="nav-link" href="#"><img src="{{ asset('awal/images/user.svg') }}"
                                alt="User"></a></li>
    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <div class="row my-5">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('awal/images/bag.svg') }}" alt="Easy to Shop"
                                        class="img-fluid">
                                </div>
                                <h3>Easy to Shop</h3>
                                <p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="{{ asset('awal/images/why-choose-us-img.jpg') }}" alt="Why Choose Us"
                            class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="imgs-grid">
                        <div class="grid grid-1"><img src="{{ asset('awal/images/img-grid-1.jpg') }}"
                                alt="Untree.co"></div>
                        <div class="grid grid-2"><img src="{{ asset('awal/images/img-grid-2.jpg') }}"
                                alt="Untree.co"></div>
                        <div class="grid grid-3"><img src="{{ asset('awal/images/img-grid-3.jpg') }}"
                                alt="Untree.co"></div>
                    </div>
                </div>
                                        ...
                                        <div class="testimonial-block text-center">
                                            ...
                                            <div class="author-info">
                                                <div class="author-pic">
                                                    <img src="{{ asset('awal/images/person-1.png') }}"
