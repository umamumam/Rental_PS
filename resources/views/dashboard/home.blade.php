                    ...
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-6">
                            <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                                <img src="{{ asset('materio/assets/img/icons/misc/zipcar.png') }}" alt="zipcar" />
                            </div>
                            <div
                        ...
                        <li class="d-flex mb-6">
                            <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                                <img src="{{ asset('materio/assets/img/icons/misc/bitbank.png') }}" alt="bitbank" />
                            </div>
                            <div
                                class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex">
                            <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                                <img src="{{ asset('materio/assets/img/icons/misc/aviato.png') }}" alt="aviato" />
                            </div>
                            <div
                                class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
