        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-6 mx-4">
                        ...
                        <a href="/" class="app-brand-link gap-3">
                            <span class="app-brand-logo demo">
                                <span style="color: #9055fd">
                                    <img src="{{ asset('logops.jpg') }}" alt="Logo Lab" width="100" height="100">
                            ...
                            {{-- <span class="app-brand-text demo text-heading fw-semibold">RSUD KESESI</span> --}}
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-1">
                        <h4 class="mb-1">Welcome to Play Arena ! 🎮</h4>
                ...
                <img src="{{ asset('materio/assets/img/illustrations/auth-basic-mask-light.png') }}"
                    ...
                    data-app-light-img="{{ asset('materio/assets/img/illustrations/auth-basic-mask-light.png') }}"
                    data-app-dark-img="{{ asset('materio/assets/img/illustrations/auth-basic-mask-dark.png') }}" />
