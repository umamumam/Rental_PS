...
<body>
    ...
    <div class="hero">
        <div class="container text-center">
            <div class="alert alert-success fw-bold fs-4 py-3">
                <i class="bi bi-check-circle-fill"></i> Pembayaran Berhasil!
            </div>
        
            <p class="fs-5">Terima kasih, <strong>{{ $booking->customer_name }}</strong>! Booking Anda telah dikonfirmasi.</p>
        
            <div class="card shadow-lg border-0 mx-auto mt-4 p-3" style="max-width: 550px; border-radius: 15px;">
                <div class="card-body">
                    <h5 class="card-title text-primary mb-3"><i class="bi bi-receipt"></i> Detail Booking</h5>
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-end">{{ $booking->customer_phone }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="text-start">Jumlah Sesi</th>
                            <td class="text-end">{{ $booking->sessions }} Sesi</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="text-start">Tanggal Booking</th>
                            <td class="text-end">{{ date('d M Y', strtotime($booking->booking_date)) }}</td>
                        </tr>
                        <tr>
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                <a href="{{ route('booking.invoice', $booking->id) }}" class="btn btn-danger px-4 py-2 fw-bold shadow-sm">
                    <i class="bi bi-file-earmark-pdf"></i> Download Invoice
                </a>
            
                <a href="/" class="btn btn-secondary px-4 py-2 fw-bold shadow-sm">
