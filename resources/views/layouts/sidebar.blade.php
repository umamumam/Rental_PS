        ...
        <a href="/dashboard" class="app-brand-link">
            <span class="app-brand-logo demo me-1">
                <span style="color: var(--bs-primary)">
                    <img src="{{ asset('hero2.webp') }}" alt="Logo Lab" width="50" height="50">
            ...
            <span class="app-brand-text demo menu-text fw-semibold ms-2" style="font-size: 14px;">Play Arena 🎮</span>
        </a>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="/games" class="menu-link">
                        <div data-i18n="CRM">Game</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="/calendar" class="menu-link">
                        <div data-i18n="CRM">Jadwal Boking</div>
                    </a>
                </li>
            </ul>
        </li>
